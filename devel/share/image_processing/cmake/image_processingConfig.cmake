...
if("TRUE" STREQUAL "TRUE")
  set(image_processing_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/image_processing)
  set(image_processing_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(image_processing_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/src/image_processing/include " STREQUAL " ")
  set(image_processing_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/image_processing/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Neal Nguyen <nealnguyen@knights.ucf.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/image_processing/${idir}'.  Ask the maintainer 'Neal Nguyen <nealnguyen@knights.ucf.edu>' to fix it.")
    endif()
...
set(image_processing_EXPORTED_TARGETS "image_processing_generate_messages_cpp;image_processing_generate_messages_eus;image_processing_generate_messages_lisp;image_processing_generate_messages_nodejs;image_processing_generate_messages_py")
...
set(pkg_cfg_extras "image_processing-msg-extras.cmake")
